...
async function attempt_signup(username, password): Promise<boolean> {
          ...
          >
            ...
            {isError && (
              <Alert color="danger" variant="solid">
                Could not create account. That username is already taken.
              </Alert>
            )}
              ...
              <Button
                ...
                onClick={async (e) => {
                  ...
                  if (username.current !== "" && password.current !== "") {
                    ...
                    const t0 = performance.now();
                    const result = await attempt_signup(
                      username.current,
                      password.current,
                    );
                    const t1 = performance.now();
